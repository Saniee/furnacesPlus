--accumulator-furnace-t1.lua

local accumulatorFurnace = table.deepcopy(data.raw["furnace"]["stone-furnace"])

accumulatorFurnace.name = "accumulator-furnace-t1"
...
accumulatorFurnace.minable.result = "accumulator-furnace-t1"
