...
accumulatorFurnace.minable.result = "accumulator-furnace-t3"
...
data:extend(
        {
                ...
                },
                {
                        ...
                        icon_size = 64,
                        icon = "__furnacesPlus__/graphics/icons/electric-furnace.png",
                        prerequisites = {"logistic-science-pack", "chemical-science-pack", "accumulator-furnace-t2", "advanced-material-processing-2", "advanced-electronics-2", "electric-engine"},
                        effects =
                        {
                          {
                            type = "unlock-recipe",
                            recipe = "accumulator-furnace-t3"
                          }
                        },
                        unit =
                        {
